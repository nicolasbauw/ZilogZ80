...
fn ld_hl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_hl.bin", 0x0100)
        .unwrap();
    c.reg.a = 0x33;
    c.reg.set_hl(0x1000);
    c.reg.pc = 0x0100;
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x1000), 0x33); // LD (HL),A
    assert_eq!(c.execute(), 7);
...
fn ld_hl_n_asm() {
    ...
    assert_eq!(c.execute(), 10);
    assert_eq!(c.bus.borrow().read_byte(0x2000), 0x33); // LD (HL),0x33
    assert_eq!(c.execute(), 10);
    assert_eq!(c.reg.get_hl(), 0x1000); // LD HL,0x1000
    assert_eq!(c.execute(), 10);
    assert_eq!(c.bus.borrow().read_byte(0x1000), 0x65); // LD (HL),0x65
}
...
fn ld_ix_iy_n_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_ix_iy_n.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 14);
    assert_eq!(c.reg.get_ix(), 0x2000); // LD IX,0x2000
    assert_eq!(c.execute(), 19);
    assert_eq!(0x33, c.bus.borrow().read_byte(0x2002)); // LD (IX+2),0x33
    assert_eq!(c.execute(), 19);
    assert_eq!(0x11, c.bus.borrow().read_byte(0x1FFE)); // LD (IX-2),0x11
    assert_eq!(c.execute(), 14);
    assert_eq!(0x1000, c.reg.get_iy()); // LD IY,0x1000
    assert_eq!(c.execute(), 19);
    assert_eq!(0x22, c.bus.borrow().read_byte(0x1001)); // LD (IY+1),0x22
    assert_eq!(c.execute(), 19);
    assert_eq!(0x44, c.bus.borrow().read_byte(0x0FFF)); // LD (IY-1),0x44
}
...
fn ld_hl_dd_ix_iy_inn_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().write_byte(0x1003, 0x04);
    c.bus.borrow_mut().write_byte(0x1004, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x06);
    c.bus.borrow_mut().write_byte(0x1006, 0x07);
    c.bus.borrow_mut().write_byte(0x1007, 0x08);
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_hl_dd_ix_iy_inn.bin", 0)
        .unwrap();
...
fn ld_ix_iy_nn_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_ix_iy_nn.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
...
fn ld_sp_hl_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_sp_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
...
fn ld_ix_iy_r_asm() {
    ...
    assert_eq!(c.execute(), 19);
    assert_eq!(0x12, c.bus.borrow().read_byte(0x1003));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x13, c.reg.b);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x13, c.bus.borrow().read_byte(0x1004));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x14, c.reg.c);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x14, c.bus.borrow().read_byte(0x1005));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x15, c.reg.d);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x15, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x16, c.reg.e);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x16, c.bus.borrow().read_byte(0x1001));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x17, c.reg.h);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x17, c.bus.borrow().read_byte(0x1006));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x18, c.reg.l);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x18, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 14);
...
fn push_pop_asm() {
    ...
    assert_eq!(0xEF00, c.bus.borrow().read_word(0x00FE));
    assert_eq!(0x00FE, c.reg.sp); // PUSH AF
    assert_eq!(c.execute(), 11);
    assert_eq!(0x1234, c.bus.borrow().read_word(0x00FC));
    assert_eq!(0x00FC, c.reg.sp); // PUSH BC
    assert_eq!(c.execute(), 11);
    assert_eq!(0x5678, c.bus.borrow().read_word(0x00FA));
    assert_eq!(0x00FA, c.reg.sp); // PUSH DE
    assert_eq!(c.execute(), 11);
    assert_eq!(0x9ABC, c.bus.borrow().read_word(0x00F8));
    assert_eq!(0x00F8, c.reg.sp); // PUSH HL
    assert_eq!(c.execute(), 15);
    assert_eq!(0x2345, c.bus.borrow().read_word(0x00F6));
    assert_eq!(0x00F6, c.reg.sp); // PUSH IX
    assert_eq!(c.execute(), 15);
    assert_eq!(0x6789, c.bus.borrow().read_word(0x00F4));
...
fn add_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x81);
    c.bus
        .borrow_mut()
        .load_bin("bin/add_i_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
...
fn add_ixh_ixl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/add_a_ixh_ixl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x0F, c.reg.a);
    assert_eq!(c.flags(), 0); // LD A,0x0F
...
fn add_a_iyh_iyl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/add_a_iyh_iyl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x0F, c.reg.a);
    assert_eq!(c.flags(), 0); // LD A,0x0F
...
fn adc_a_ixh_ixl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/adc_a_ixh_ixl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x00, c.reg.a); // LD A,0x00
    assert_eq!(c.execute(), 14);
...
fn adc_a_iyh_iyl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/adc_a_iyh_iyl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x00, c.reg.a); // LD A,0x00
    assert_eq!(c.execute(), 14);
...
fn adc_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x61);
    c.bus.borrow_mut().write_byte(0x1002, 0x81);
    c.bus.borrow_mut().write_byte(0x1003, 0x02);
    c.bus
        .borrow_mut()
        .load_bin("bin/adc_i_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
    assert_eq!(0x1000, c.reg.get_hl()); // LD HL,0x1000
    assert_eq!(c.execute(), 14);
...
fn sub_ixh_ixl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sub_ixh_ixl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x04, c.reg.a); // LD A,0x04
    assert_eq!(c.execute(), 14);
...
fn sub_iyh_iyl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sub_iyh_iyl.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 7);
    assert_eq!(0x04, c.reg.a); // LD A,0x04
    assert_eq!(c.execute(), 14);
...
fn sub_i_hl_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sub_i_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
    assert_eq!(0x1000, c.reg.get_hl()); // LD HL,0x1000
    assert_eq!(c.execute(), 14);
...
fn cp_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1000, 0x41);
    c.bus.borrow_mut().write_byte(0x1001, 0x61);
    c.bus.borrow_mut().write_byte(0x1002, 0x22);
    c.bus
        .borrow_mut()
        .load_bin("bin/cp_i_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
    assert_eq!(0x1000, c.reg.get_hl()); // LD HL,0x1000
    assert_eq!(c.execute(), 14);
...
fn sbc_ixyh_ixyl_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sbc_ixyh_ixyl.bin", 0)
        .unwrap();
    c.execute();
    c.execute();
    assert_eq!(c.execute(), 4);
...
fn sbc_i_hl_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sbc_i_hl_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
...
fn or_xor_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x84);
    c.bus
        .borrow_mut()
        .load_bin("bin/or_xor_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
...
fn and_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x99);
    c.bus
        .borrow_mut()
        .load_bin("bin/and_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..4 {
        c.execute();
    }
...
fn inc_dec_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x7F);
    c.bus
        .borrow_mut()
        .load_bin("bin/inc_dec_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 11);
    assert_eq!(0xFF, c.bus.borrow().read_byte(0x1000));
    ...
    assert_eq!(0x40, c.bus.borrow().read_byte(0x1001));
    assert_eq!(c.flags(), HF); // INC (IX+1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x3F, c.bus.borrow().read_byte(0x1001));
    assert_eq!(c.flags(), HF | NF); // DEC (IX+1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x80, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.flags(), SF | HF | VF); // INC (IY-1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x7F, c.bus.borrow().read_byte(0x1002));
...
fn inc_dec_ss_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/inc_dec_ss_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..6 {
        c.execute();
    }
...
fn ld_i_hl_r_asm() {
    ...
    assert_eq!(0x12, c.reg.a);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x12, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x13, c.reg.b);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x13, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x14, c.reg.c);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x14, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x15, c.reg.d);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x15, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x16, c.reg.e);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x16, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x10, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    assert_eq!(0x00, c.bus.borrow().read_byte(0x1000));
}
...
fn ld_a_i_bc_de_nn_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_a_i_bc_de_nn.bin", 0)
        .unwrap();
    c.bus.borrow_mut().write_byte(0x1000, 0x11);
    c.bus.borrow_mut().write_byte(0x1001, 0x22);
    c.bus.borrow_mut().write_byte(0x1002, 0x33);
    assert_eq!(c.execute(), 10);
...
fn ld_i_bc_de_nn_a_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_i_bc_de_nn_a.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
    ...
    assert_eq!(c.execute(), 7);
    assert_eq!(0x77, c.bus.borrow().read_byte(0x1000)); // LD (BC),A
    assert_eq!(c.execute(), 7);
    assert_eq!(0x77, c.bus.borrow().read_byte(0x1001)); // LD (DE),A
    assert_eq!(c.execute(), 13);
    assert_eq!(0x77, c.bus.borrow().read_byte(0x1002)); // LD (0x1002),A
}
...
fn call_ret_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/call_ret.bin", 0x0204)
        .unwrap();
    c.reg.pc = 0x0204;
    assert_eq!(c.execute(), 17);
    assert_eq!(0x020A, c.reg.pc);
    assert_eq!(0xFFFE, c.reg.sp);
    assert_eq!(0x0207, c.bus.borrow().read_word(0xFFFE));
    assert_eq!(c.execute(), 10);
    assert_eq!(0x0207, c.reg.pc);
    ...
    assert_eq!(0x020A, c.reg.pc);
    assert_eq!(0xFFFE, c.reg.sp);
    assert_eq!(0x020A, c.bus.borrow().read_word(0xFFFE));
    assert_eq!(c.execute(), 10);
    assert_eq!(0x020A, c.reg.pc);
    assert_eq!(0x0000, c.reg.sp);
}
...
fn call_cc_ret_cc_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/call_cc_ret_cc.bin", 0x0204)
        .unwrap();
    c.reg.pc = 0x0204;
    c.reg.sp = 0x0100;
    assert_eq!(c.execute(), 4);
...
fn ex_asm() {
    ...
    assert_eq!(c.execute(), 11);
    assert_eq!(0x1234, c.bus.borrow().read_word(0x00FE));
    assert_eq!(c.execute(), 19);
    assert_eq!(0x1234, c.reg.get_hl());
    assert_eq!(0x5678, c.bus.borrow().read_word(0x00FE));
    assert_eq!(c.execute(), 14);
    assert_eq!(0x8899, c.reg.get_ix(),);
    assert_eq!(c.execute(), 23);
    assert_eq!(0x5678, c.reg.get_ix(),);
    assert_eq!(0x8899, c.bus.borrow().read_word(0x00FE));
    assert_eq!(c.execute(), 14);
    assert_eq!(0x6677, c.reg.get_iy());
    assert_eq!(c.execute(), 23);
    assert_eq!(0x8899, c.reg.get_iy());
    assert_eq!(0x6677, c.bus.borrow().read_word(0x00FE));
}
...
fn jp_cc_nn_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/jp_cc_nn.bin", 0x0204)
        .unwrap();
    c.reg.pc = 0x0204;
    assert_eq!(c.execute(), 4);
    assert_eq!(0x00, c.reg.a);
...
fn ldi_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x02);
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().load_bin("bin/ldi.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 16);
...
fn ldir_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x02);
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().load_bin("bin/ldir.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    c.execute();
...
fn ldd_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x02);
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().load_bin("bin/ldd.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 16);
...
fn lddr_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x02);
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().load_bin("bin/lddr.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    c.execute();
...
fn cpi_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().write_byte(0x1003, 0x04);
    c.bus.borrow_mut().load_bin("bin/cpi.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 16);
...
fn cpir_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().write_byte(0x1003, 0x04);
    c.bus.borrow_mut().load_bin("bin/cpir.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
...
fn cpd_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x03);
    c.bus.borrow_mut().write_byte(0x1003, 0x04);
    c.bus.borrow_mut().load_bin("bin/cpd.bin", 0).unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 16);
...
fn add_adc_sbc_16_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/add_adc_sbc_16.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
...
fn ld_inn_hl_dd_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/ld_inn_hl_dd_ix_iy.bin", 0)
        .unwrap();
    assert_eq!(c.execute(), 10);
    assert_eq!(0x0201, c.reg.get_hl()); // LD HL,0x0201
    assert_eq!(c.execute(), 16);
    assert_eq!(0x0201, c.bus.borrow().read_word(0x1000)); // LD (0x1000),HL
    assert_eq!(c.execute(), 10);
    assert_eq!(0x1234, c.reg.get_bc()); // LD BC,0x1234
    assert_eq!(c.execute(), 20);
    assert_eq!(0x1234, c.bus.borrow().read_word(0x1002)); // LD (0x1002),BC
    assert_eq!(c.execute(), 10);
    assert_eq!(0x5678, c.reg.get_de()); // LD DE,0x5678
    assert_eq!(c.execute(), 20);
    assert_eq!(0x5678, c.bus.borrow().read_word(0x1004)); // LD (0x1004),DE
    assert_eq!(c.execute(), 10);
    assert_eq!(0x9ABC, c.reg.get_hl()); // LD HL,0x9ABC
    assert_eq!(c.execute(), 16);
    assert_eq!(0x9ABC, c.bus.borrow().read_word(0x1006)); // LD (0x1006),HL
    assert_eq!(c.execute(), 10);
    assert_eq!(0x1368, c.reg.sp); // LD SP,0x1368
    assert_eq!(c.execute(), 20);
    assert_eq!(0x1368, c.bus.borrow().read_word(0x1008)); // LD (0x1008),SP
    assert_eq!(c.execute(), 14);
    assert_eq!(0x4321, c.reg.get_ix(),); // LD IX,0x4321
    assert_eq!(c.execute(), 20);
    assert_eq!(0x4321, c.bus.borrow().read_word(0x100A)); // LD (0x100A),IX
    assert_eq!(c.execute(), 14);
    assert_eq!(0x8765, c.reg.get_iy()); // LD IY,0x8765
    assert_eq!(c.execute(), 20);
    assert_eq!(0x8765, c.bus.borrow().read_word(0x100C)); // LD (0x100C),IY
}
...
fn rlc_rl_rrc_rr_r_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/rlc_rl_rrc_rr_r.bin", 0)
        .unwrap();
    for _ in 0..7 {
        c.execute();
    }
...
fn rrc_rlc_rr_rl_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0x11);
    c.bus
        .borrow_mut()
        .load_bin("bin/rrc_rlc_rr_rl_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 15);
    assert_eq!(0x80, c.bus.borrow().read_byte(0x1000));
    ...
    assert_eq!(c.execute(), 23);
    assert_eq!(0xFF, c.bus.borrow().read_byte(0x1001));
    ...
    assert_eq!(0xFF, c.reg.a); // LD A,(IX+1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x88, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.flags(), SF | PF | CF); // RRC (IY-1)
    assert_eq!(c.execute(), 19);
    assert_eq!(0x88, c.reg.a); // LD A,(IY-1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x11, c.bus.borrow().read_byte(0x1002));
    ...
    assert_eq!(0xFF, c.reg.a); // LD A,(IX+1)
    assert_eq!(c.execute(), 23);
    assert_eq!(0x23, c.bus.borrow().read_byte(0x1002));
...
fn sla_i_hl_ix_iy_asm() {
    ...
    c.bus.borrow_mut().write_byte(0x1002, 0xAA);
    c.bus
        .borrow_mut()
        .load_bin("bin/sla_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
    assert_eq!(c.execute(), 15);
    assert_eq!(0x02, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.flags(), 0);
    assert_eq!(c.execute(), 7);
    assert_eq!(0x02, c.reg.a);
    assert_eq!(c.execute(), 23);
    assert_eq!(0x00, c.bus.borrow().read_byte(0x1001));
    assert_eq!(c.flags(), ZF | PF | CF);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x00, c.reg.a);
    assert_eq!(c.execute(), 23);
    assert_eq!(0x54, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.flags(), CF);
    assert_eq!(c.execute(), 19);
...
fn sra_i_hl_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/sra_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
    ...
    assert_eq!(0x00, c.reg.a);
    assert_eq!(c.execute(), 23);
    assert_eq!(0xC0, c.bus.borrow().read_byte(0x1001));
    assert_eq!(c.flags(), SF | PF);
    assert_eq!(c.execute(), 19);
    assert_eq!(0xC0, c.reg.a);
    assert_eq!(c.execute(), 23);
    assert_eq!(0xD5, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.flags(), SF);
    assert_eq!(c.execute(), 19);
...
fn srl_i_hl_ix_iy_asm() {
    ...
    c.bus
        .borrow_mut()
        .load_bin("bin/srl_i_hl_ix_iy.bin", 0)
        .unwrap();
    for _ in 0..3 {
        c.execute();
    }
    ...
    assert_eq!(0x40, c.reg.a);
    assert_eq!(c.execute(), 23);
    assert_eq!(0x55, c.bus.borrow().read_byte(0x1002));
    assert_eq!(c.flags(), PF);
    assert_eq!(c.execute(), 19);
    assert_eq!(0x55, c.reg.a);
}
...
fn rld_rrd_asm() {
    ...
    assert_eq!(0x1000, c.reg.get_hl());
    assert_eq!(c.execute(), 10);
    assert_eq!(0x34, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 18);
    assert_eq!(0x14, c.reg.a);
    assert_eq!(0x23, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 18);
    assert_eq!(0x12, c.reg.a);
    assert_eq!(0x34, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.execute(), 7);
    ...
    assert_eq!(c.execute(), 18);
    assert_eq!(0xF0, c.reg.a);
    assert_eq!(0x0E, c.bus.borrow().read_byte(0x1000));
    assert_eq!(c.flags(), SF | PF);
    assert_eq!(c.execute(), 18);
    assert_eq!(0xFE, c.reg.a);
    assert_eq!(0x00, c.bus.borrow().read_byte(0x1000));
...
fn ld_inn_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x06);
    c.bus.borrow_mut().write_byte(0x0003, 0x10);
    c.reg.set_hl(0x9ABC);
    assert_eq!(c.execute(), 20);
    assert_eq!(0x9ABC, c.bus.borrow().read_word(0x1006));
}
...
fn ld_b() {
    ...
    c.reg.h = 0x25;
    c.reg.l = 0x2F;
    c.bus.borrow_mut().write_byte(0x252f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x40);
    c.bus.borrow_mut().write_byte(0x0001, 0x41);
    c.bus.borrow_mut().write_byte(0x0002, 0x42);
    c.bus.borrow_mut().write_byte(0x0003, 0x43);
    c.bus.borrow_mut().write_byte(0x0004, 0x44);
    c.bus.borrow_mut().write_byte(0x0005, 0x45);
    c.bus.borrow_mut().write_byte(0x0006, 0x46);
    c.bus.borrow_mut().write_byte(0x0007, 0x47);
    assert_eq!(c.execute(), 4);
...
fn ld_c() {
    ...
    c.bus.borrow_mut().write_byte(0x252f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x48);
    c.bus.borrow_mut().write_byte(0x0001, 0x49);
    c.bus.borrow_mut().write_byte(0x0002, 0x4a);
    c.bus.borrow_mut().write_byte(0x0003, 0x4b);
    c.bus.borrow_mut().write_byte(0x0004, 0x4c);
    c.bus.borrow_mut().write_byte(0x0005, 0x4d);
    c.bus.borrow_mut().write_byte(0x0006, 0x4e);
    c.bus.borrow_mut().write_byte(0x0007, 0x4f);
    assert_eq!(c.execute(), 4);
...
fn ld_d() {
    ...
    c.bus.borrow_mut().write_byte(0x252f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x50);
    c.bus.borrow_mut().write_byte(0x0001, 0x51);
    c.bus.borrow_mut().write_byte(0x0002, 0x52);
    c.bus.borrow_mut().write_byte(0x0003, 0x53);
    c.bus.borrow_mut().write_byte(0x0004, 0x54);
    c.bus.borrow_mut().write_byte(0x0005, 0x55);
    c.bus.borrow_mut().write_byte(0x0006, 0x56);
    c.bus.borrow_mut().write_byte(0x0007, 0x57);
    assert_eq!(c.execute(), 4);
...
fn ld_e() {
    ...
    c.bus.borrow_mut().write_byte(0x252f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x58);
    c.bus.borrow_mut().write_byte(0x0001, 0x59);
    c.bus.borrow_mut().write_byte(0x0002, 0x5a);
    c.bus.borrow_mut().write_byte(0x0003, 0x5b);
    c.bus.borrow_mut().write_byte(0x0004, 0x5c);
    c.bus.borrow_mut().write_byte(0x0005, 0x5d);
    c.bus.borrow_mut().write_byte(0x0006, 0x5e);
    c.bus.borrow_mut().write_byte(0x0007, 0x5f);
    assert_eq!(c.execute(), 4);
...
fn ld_h() {
    ...
    c.reg.h = 0x25;
    c.reg.l = 0x2F;
    c.bus.borrow_mut().write_byte(0x2f2f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x60);
    c.bus.borrow_mut().write_byte(0x0001, 0x61);
    c.bus.borrow_mut().write_byte(0x0002, 0x62);
    c.bus.borrow_mut().write_byte(0x0003, 0x63);
    c.bus.borrow_mut().write_byte(0x0004, 0x64);
    c.bus.borrow_mut().write_byte(0x0005, 0x65);
    c.bus.borrow_mut().write_byte(0x0006, 0x66);
    c.bus.borrow_mut().write_byte(0x0007, 0x67);
    assert_eq!(c.execute(), 4);
...
fn ld_l() {
    ...
    c.reg.h = 0x25;
    c.reg.l = 0x2F;
    c.bus.borrow_mut().write_byte(0x2525, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x68);
    c.bus.borrow_mut().write_byte(0x0001, 0x69);
    c.bus.borrow_mut().write_byte(0x0002, 0x6a);
    c.bus.borrow_mut().write_byte(0x0003, 0x6b);
    c.bus.borrow_mut().write_byte(0x0004, 0x6c);
    c.bus.borrow_mut().write_byte(0x0005, 0x6d);
    c.bus.borrow_mut().write_byte(0x0006, 0x6e);
    c.bus.borrow_mut().write_byte(0x0007, 0x6f);
    assert_eq!(c.execute(), 4);
...
fn ld_hl_r() {
    ...
    c.bus.borrow_mut().write_byte(0x2f2f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x70);
    c.bus.borrow_mut().write_byte(0x0001, 0x71);
    c.bus.borrow_mut().write_byte(0x0002, 0x72);
    c.bus.borrow_mut().write_byte(0x0003, 0x73);
    c.bus.borrow_mut().write_byte(0x0004, 0x74);
    c.bus.borrow_mut().write_byte(0x0005, 0x75);
    c.bus.borrow_mut().write_byte(0x0006, 0x77);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x11);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x15);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x1f);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x21);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x25);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x2f);
    assert_eq!(c.execute(), 7);
    assert_eq!(c.bus.borrow().read_byte(0x252f), 0x3f);
...
fn ld_a() {
    ...
    c.bus.borrow_mut().write_byte(0x252f, 0x31);
    c.reg.a = 0x3F;
    c.bus.borrow_mut().write_byte(0x0000, 0x78);
    c.bus.borrow_mut().write_byte(0x0001, 0x79);
    c.bus.borrow_mut().write_byte(0x0002, 0x7a);
    c.bus.borrow_mut().write_byte(0x0003, 0x7b);
    c.bus.borrow_mut().write_byte(0x0004, 0x7c);
    c.bus.borrow_mut().write_byte(0x0005, 0x7d);
    c.bus.borrow_mut().write_byte(0x0006, 0x7e);
    c.bus.borrow_mut().write_byte(0x0007, 0x7f);
    assert_eq!(c.execute(), 4);
...
fn ld_b_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0x46);
    c.bus.borrow_mut().write_byte(0x0002, 0x19);
    c.bus.borrow_mut().write_byte(0x25C8, 0x39);
    assert_eq!(c.execute(), 19);
...
fn ld_ix_d_c() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x06);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.bus.borrow().read_byte(0x3106), 0x1C);
    assert_eq!(c.reg.pc, 3);
}
...
fn ld_ix_d_n() {
    ...
    c.reg.set_ix(0x219A);
    c.bus.borrow_mut().write_byte(0x0000, 0xDD);
    c.bus.borrow_mut().write_byte(0x0001, 0x36);
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x0003, 0x5A);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.bus.borrow().read_byte(0x219F), 0x5A);
...
fn ld_nn_a() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0xff);
    c.reg.a = 0x56;
    assert_eq!(c.execute(), 13);
    assert_eq!(c.reg.pc, 0x0003);
    assert_eq!(c.bus.borrow().read_byte(0xff00), 0x56);
}
...
fn ld_dd_nn() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0x00);
    c.bus.borrow_mut().write_byte(0x0002, 0x50);
    assert_eq!(c.execute(), 10);
    assert_eq!(c.reg.pc, 0x0003);
...
fn ld_ix_nn() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0xA2);
    c.bus.borrow_mut().write_byte(0x0003, 0x45);
    assert_eq!(c.execute(), 14);
...
fn ld_hl_nn() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x45);
    c.bus.borrow_mut().write_byte(0x4545, 0x37);
    c.bus.borrow_mut().write_byte(0x4546, 0xA1);
    assert_eq!(c.execute(), 16);
    assert_eq!(c.reg.pc, 0x0003);
...
fn ld_bc_cnn() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x30);
    c.bus.borrow_mut().write_byte(0x0003, 0x21);
    c.bus.borrow_mut().write_byte(0x2130, 0x65);
    c.bus.borrow_mut().write_byte(0x2131, 0x78);
    assert_eq!(c.execute(), 20);
    assert_eq!(c.reg.pc, 0x0004);
...
fn ld_ix_cnn() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x66);
    c.bus.borrow_mut().write_byte(0x0003, 0x66);
    c.bus.borrow_mut().write_byte(0x6666, 0x92);
    c.bus.borrow_mut().write_byte(0x6667, 0xDA);
    assert_eq!(c.execute(), 20);
    assert_eq!(c.reg.pc, 0x0004);
...
fn ld_cnn_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0xB2);
    c.reg.set_hl(0x483A);
    assert_eq!(c.execute(), 16);
    assert_eq!(c.reg.pc, 0x0003);
    assert_eq!(c.bus.borrow().read_byte(0xB229), 0x3A);
    assert_eq!(c.bus.borrow().read_byte(0xB22A), 0x48);
}
...
fn ld_ann_bc() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x00);
    c.bus.borrow_mut().write_byte(0x0003, 0x10);
    c.reg.set_bc(0x4644);
    assert_eq!(c.execute(), 20);
    assert_eq!(c.reg.pc, 0x0004);
    assert_eq!(c.bus.borrow().read_byte(0x1000), 0x44);
    assert_eq!(c.bus.borrow().read_byte(0x1001), 0x46);
}
...
fn ld_ann_ix() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x38);
    c.bus.borrow_mut().write_byte(0x0003, 0x88);
    c.reg.set_ix(0x4174);
    assert_eq!(c.execute(), 20);
    assert_eq!(c.reg.pc, 0x0004);
    assert_eq!(c.bus.borrow().read_byte(0x8838), 0x74);
    assert_eq!(c.bus.borrow().read_byte(0x8839), 0x41);
}
...
fn push_af() {
    ...
    assert_eq!(c.bus.borrow().read_byte(0x1005), 0x33);
    assert_eq!(c.bus.borrow().read_byte(0x1006), 0x22);
    assert_eq!(c.reg.sp, 0x1005);
}
...
fn pop_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0x33);
    c.reg.sp = 0x1000;
    assert_eq!(c.execute(), 10);
    assert_eq!(c.reg.pc, 1);
...
fn ex_sp_hl() {
    ...
    c.reg.set_hl(0x7012);
    c.reg.sp = 0x8856;
    c.bus.borrow_mut().write_byte(0x8856, 0x11);
    c.bus.borrow_mut().write_byte(0x8857, 0x22);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 1);
    assert_eq!(c.reg.get_hl(), 0x2211);
    assert_eq!(c.bus.borrow().read_byte(0x8856), 0x12);
    assert_eq!(c.bus.borrow().read_byte(0x8857), 0x70);
...
fn ex_sp_ix() {
    ...
    c.reg.set_ix(0x3988);
    c.reg.sp = 0x0100;
    c.bus.borrow_mut().write_byte(0x0100, 0x90);
    c.bus.borrow_mut().write_byte(0x0101, 0x48);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_ix(), 0x4890);
    assert_eq!(c.bus.borrow().read_byte(0x0100), 0x88);
    assert_eq!(c.bus.borrow().read_byte(0x0101), 0x39);
...
fn ldi() {
    ...
    c.reg.set_de(0x2222);
    c.reg.set_bc(0x07);
    c.bus.borrow_mut().write_byte(0x1111, 0x88);
    c.bus.borrow_mut().write_byte(0x2222, 0x66);
    assert_eq!(c.execute(), 16);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_hl(), 0x1112);
    assert_eq!(c.bus.borrow().read_byte(0x1111), 0x88);
    assert_eq!(c.reg.get_de(), 0x2223);
    assert_eq!(c.bus.borrow().read_byte(0x2222), 0x88);
...
fn ldir() {
    ...
    c.bus.borrow_mut().write_byte(0x1111, 0x88);
    c.bus.borrow_mut().write_byte(0x2222, 0x66);
    c.bus.borrow_mut().write_byte(0x1112, 0x36);
    c.bus.borrow_mut().write_byte(0x2223, 0x59);
    c.bus.borrow_mut().write_byte(0x1113, 0xA5);
    c.bus.borrow_mut().write_byte(0x2224, 0xC5);
    assert_eq!(c.execute(), 21);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_hl(), 0x1114);
    assert_eq!(c.bus.borrow().read_byte(0x1111), 0x88);
    assert_eq!(c.bus.borrow().read_byte(0x1112), 0x36);
    assert_eq!(c.bus.borrow().read_byte(0x1113), 0xA5);
    assert_eq!(c.reg.get_de(), 0x2225);
    assert_eq!(c.bus.borrow().read_byte(0x2222), 0x88);
    assert_eq!(c.bus.borrow().read_byte(0x2223), 0x36);
    assert_eq!(c.bus.borrow().read_byte(0x2224), 0xA5);
...
fn lddr() {
    ...
    c.reg.set_de(0x2225);
    c.reg.set_bc(0x0003);
    c.bus.borrow_mut().write_byte(0x1112, 0x88);
    c.bus.borrow_mut().write_byte(0x2223, 0x66);
    c.bus.borrow_mut().write_byte(0x1113, 0x36);
    c.bus.borrow_mut().write_byte(0x2224, 0x59);
    c.bus.borrow_mut().write_byte(0x1114, 0xA5);
    c.bus.borrow_mut().write_byte(0x2225, 0xC5);
    assert_eq!(c.execute(), 21);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_hl(), 0x1111);
    assert_eq!(c.bus.borrow().read_byte(0x1112), 0x88);
    assert_eq!(c.bus.borrow().read_byte(0x1113), 0x36);
    assert_eq!(c.bus.borrow().read_byte(0x1114), 0xA5);
    assert_eq!(c.reg.get_de(), 0x2222);
    assert_eq!(c.bus.borrow().read_byte(0x2223), 0x88);
    assert_eq!(c.bus.borrow().read_byte(0x2224), 0x36);
    assert_eq!(c.bus.borrow().read_byte(0x2225), 0xA5);
    assert_eq!(c.reg.get_bc(), 0x00);
}
...
fn cpi() {
    ...
    c.reg.set_hl(0x1111);
    c.reg.set_bc(0x01);
    c.bus.borrow_mut().write_byte(0x1111, 0x3B);
    assert_eq!(c.execute(), 16);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_hl(), 0x1112);
    assert_eq!(c.reg.get_bc(), 0);
    assert!(c.reg.flags.z);
    assert!(!c.reg.flags.p);
}
...
fn cpir() {
    ...
    c.reg.set_hl(0x1111);
    c.reg.set_bc(0x07);
    c.bus.borrow_mut().write_byte(0x1111, 0x52);
    c.bus.borrow_mut().write_byte(0x1112, 0x00);
    c.bus.borrow_mut().write_byte(0x1113, 0xF3);
    assert_eq!(c.execute(), 21);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.get_hl(), 0x1114);
...
fn cpdr() {
    ...
    c.reg.set_hl(0x1118);
    c.reg.set_bc(0x07);
    c.bus.borrow_mut().write_byte(0x1116, 0xF3);
    c.bus.borrow_mut().write_byte(0x1117, 0x00);
    c.bus.borrow_mut().write_byte(0x1118, 0x52);
    assert_eq!(c.execute(), 21);
    assert_eq!(c.reg.pc, 2);
...
fn add_a_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x22);
    c.reg.a = 0x11;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 3);
...
fn and_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x7B);
    c.reg.a = 0xC3;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 3);
...
fn or_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x48);
    c.reg.a = 0x12;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 3);
...
fn xor_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x5D);
    c.reg.a = 0x96;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 3);
...
fn cp_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x1005, 0x05);
    c.reg.a = 0x0A;
    assert_eq!(c.execute(), 19);
    assert_eq!(c.reg.pc, 3);
    assert!(!c.reg.flags.z);
...
fn inc_c_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x100, 0xff);
    c.reg.set_hl(0x100);
    assert_eq!(c.execute(), 11);
    assert_eq!(c.reg.pc, 0x0001);
    assert_eq!(0, c.bus.borrow().read_byte(0x100));
    assert!(c.reg.flags.z);
    c.execute();
    assert_eq!(c.reg.pc, 0x0002);
    assert_eq!(1, c.bus.borrow().read_byte(0x100));
    assert!(!c.reg.flags.z);
}
...
fn inc_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0x34);
    c.bus.borrow_mut().write_byte(0x0002, 0x05);
    c.bus.borrow_mut().write_byte(0x105, 0xff);
    c.reg.set_ix(0x100);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 0x03);
    assert_eq!(0, c.bus.borrow().read_byte(0x105));
    assert!(c.reg.flags.z);
}
...
fn dcr_m() {
    ...
    c.bus.borrow_mut().write_byte(0x100, 0x55);
    c.reg.set_hl(0x0100);
    assert_eq!(c.execute(), 11);
    assert_eq!(c.reg.pc, 1);
    assert_eq!(0x54, c.bus.borrow().read_byte(0x0100));
    assert!(!c.reg.flags.z);
    c.execute();
    assert_eq!(c.reg.pc, 2);
    assert_eq!(0x53, c.bus.borrow().read_byte(0x0100));
    assert!(!c.reg.flags.z);
}
...
fn dec_ix_d() {
    ...
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 0x03);
    assert_eq!(0xFE, c.bus.borrow().read_byte(0x105));
    assert!(!c.reg.flags.z);
}
...
fn rlc_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x2828, 0b10001000);
    c.reg.set_hl(0x2828);
    assert_eq!(c.execute(), 15);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.bus.borrow().read_byte(0x2828), 0b00010001);
    assert!(c.reg.flags.c);
}
...
fn rlc_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x06);
    c.bus.borrow_mut().write_byte(0x1002, 0b10001000);
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b00010001);
    assert!(c.reg.flags.c);
}
...
fn rl_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x16);
    c.bus.borrow_mut().write_byte(0x1002, 0b10001111);
    c.reg.flags.c = false;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b00011110);
    assert!(c.reg.flags.c);
}
...
fn read_le_dword() {
    ...
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x16);
    assert_eq!(c.bus.borrow().read_le_dword(0), 0xFDCB0216);
}
...
fn rrc_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x0E);
    c.bus.borrow_mut().write_byte(0x1002, 0b00110001);
    c.reg.flags.c = false;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b10011000);
    assert!(c.reg.flags.c);
}
...
fn rr_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x4343, 0b11011101);
    c.reg.set_hl(0x4343);
    assert_eq!(c.execute(), 15);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.bus.borrow().read_byte(0x4343), 0b01101110);
    assert!(c.reg.flags.c);
}
...
fn rr_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x1E);
    c.bus.borrow_mut().write_byte(0x1002, 0b11011101);
    c.reg.flags.c = false;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b01101110);
    assert!(c.reg.flags.c);
}
...
fn sla_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x26);
    c.bus.borrow_mut().write_byte(0x1002, 0b10110001);
    c.reg.flags.c = false;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b01100010);
    assert!(c.reg.flags.c);
}
...
fn sra_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x02);
    c.bus.borrow_mut().write_byte(0x0003, 0x2E);
    c.bus.borrow_mut().write_byte(0x1002, 0b10111000);
    c.reg.flags.c = false;
    c.reg.set_ix(0x1000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x1002), 0b11011100);
    assert!(!c.reg.flags.c);
}
...
fn rld() {
    ...
    c.bus.borrow_mut().write_byte(0x5000, 0b00110001);
    c.reg.set_hl(0x5000);
    c.reg.a = 0b01111010;
    assert_eq!(c.execute(), 18);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.a, 0b01110011);
    assert_eq!(c.bus.borrow().read_byte(0x5000), 0b00011010);
}
...
fn rrd() {
    ...
    c.bus.borrow_mut().write_byte(0x5000, 0b00100000);
    c.reg.set_hl(0x5000);
    c.reg.a = 0b10000100;
    assert_eq!(c.execute(), 18);
    assert_eq!(c.reg.pc, 2);
    assert_eq!(c.reg.a, 0b10000000);
    assert_eq!(c.bus.borrow().read_byte(0x5000), 0b01000010);
}
...
fn bit_4_hl() {
    ...
    c.bus.borrow_mut().write_byte(0x4444, 0x10);
    c.reg.set_hl(0x4444);
    assert_eq!(c.execute(), 12);
    assert_eq!(c.reg.pc, 2);
    assert!(!c.reg.flags.z);
    assert_eq!(c.bus.borrow().read_byte(0x4444), 0x10);
}
...
fn bit_6_ix_d() {
    ...
    c.bus.borrow_mut().write_byte(0x0000, 0xDD);
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x04);
    c.bus.borrow_mut().write_byte(0x0003, 0x76);
    c.bus.borrow_mut().write_byte(0x2004, 0x40);
    c.reg.set_ix(0x2000);
    assert_eq!(c.execute(), 20);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x2004), 0x40);
    assert!(!c.reg.flags.z);
}
...
fn set_0_ix() {
    ...
    c.bus.borrow_mut().write_byte(0x0000, 0xDD);
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x03);
    c.bus.borrow_mut().write_byte(0x0003, 0xC6);
    c.reg.set_ix(0x2000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x2003), 0x01);
}
...
fn reset_0_ix() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0xCB);
    c.bus.borrow_mut().write_byte(0x0002, 0x03);
    c.bus.borrow_mut().write_byte(0x0003, 0xB6);
    c.bus.borrow_mut().write_byte(0x2003, 0xFF);
    c.reg.set_ix(0x2000);
    assert_eq!(c.execute(), 23);
    assert_eq!(c.reg.pc, 4);
    assert_eq!(c.bus.borrow().read_byte(0x2003), 0xBF);
}
...
fn jp() {
    ...
    c.bus.borrow_mut().write_byte(0x0001, 0x00);
    c.bus.borrow_mut().write_byte(0x0002, 0x3E);
    assert_eq!(c.execute(), 10);
...
fn jr() {
    ...
    c.bus.borrow_mut().write_byte(0x0481, 0x03);
    assert_eq!(c.execute(), 12);
...
fn jr_neg() {
    ...
    c.reg.pc = 0x0480;
    c.bus.borrow_mut().write_byte(0x0480, 0x18);
    c.bus.borrow_mut().write_byte(0x0481, 0xFA);
    assert_eq!(c.execute(), 12);
...
fn jr_z_e() {
    ...
    c.bus.borrow_mut().write_byte(0x0301, 0x03);
    c.reg.flags.z = true;
    assert_eq!(c.execute(), 12);
...
fn jp_ix() {
    ...
    c.bus.borrow_mut().write_byte(0x1001, 0xE9);
    c.reg.set_ix(0x4800);
    assert_eq!(c.execute(), 8);
    assert_eq!(c.reg.pc, 0x4800);
}
...
fn call_nn() {
    ...
    c.reg.pc = 0x1A47;
    c.reg.sp = 0x3002;
    c.bus.borrow_mut().write_byte(0x1A47, 0xCD);
    c.bus.borrow_mut().write_byte(0x1A48, 0x35);
    c.bus.borrow_mut().write_byte(0x1A49, 0x21);
    assert_eq!(c.execute(), 17);
    assert_eq!(c.bus.borrow().read_byte(0x3001), 0x1A);
    assert_eq!(c.bus.borrow().read_byte(0x3000), 0x4A);
...
fn call_cc_nn() {
    ...
    c.reg.pc = 0x1A47;
    c.reg.sp = 0x3002;
    c.bus.borrow_mut().write_byte(0x1A47, 0xD4);
    c.bus.borrow_mut().write_byte(0x1A48, 0x35);
    c.bus.borrow_mut().write_byte(0x1A49, 0x21);
    assert_eq!(c.execute(), 17);
    assert_eq!(c.bus.borrow().read_byte(0x3001), 0x1A);
...
fn ret() {
    ...
    c.reg.pc = 0x3535;
    c.reg.sp = 0x2000;
    c.bus.borrow_mut().write_byte(0x3535, 0xC9);
    c.bus.borrow_mut().write_byte(0x2000, 0xB5);
    c.bus.borrow_mut().write_byte(0x2001, 0x18);
    assert_eq!(c.execute(), 10);
...
fn ret_cc() {
    ...
    c.reg.pc = 0x3535;
    c.reg.sp = 0x2000;
    c.bus.borrow_mut().write_byte(0x3535, 0xF8);
    c.bus.borrow_mut().write_byte(0x2000, 0xB5);
    c.bus.borrow_mut().write_byte(0x2001, 0x18);
    assert_eq!(c.execute(), 11);
    assert_eq!(c.reg.sp, 0x2002);
...
fn jr_nz_neg() {
    ...
    c.bus.borrow_mut().write_byte(0x0275, 0x08);
    c.bus.borrow_mut().write_byte(0x0276, 0x0D); // DEC C
    c.bus.borrow_mut().write_byte(0x0277, 0x20); // JR NZ,$F2
    c.bus.borrow_mut().write_byte(0x0278, 0xF2);
    for _ in 0..3 {
        c.execute();
    }
...
fn jr_nz_neg_false() {
    ...
    c.reg.pc = 0x0274;
    c.bus.borrow_mut().write_byte(0x0274, 0x0E); // LD C,$08
    c.bus.borrow_mut().write_byte(0x0275, 0x01);
    c.bus.borrow_mut().write_byte(0x0276, 0x0D); // DEC C
    c.bus.borrow_mut().write_byte(0x0277, 0x20); // JR NZ,$F2
    c.bus.borrow_mut().write_byte(0x0278, 0xF2);
    for _ in 0..3 {
